...
_STRINGS: dict[str, dict[str, str]] = {
    ...
    "sqlpool.indicator_monitor": {"en": "SQL {running} running", "zh": "SQL {running} 执行中"},
    "sqlpool.monitor_only": {"en": "Monitoring running SQL — cost governor off (set a budget in Settings → Resources).",
                             "zh": "SQL 运行监控——成本护栏未启用（在 设置 → 资源 设置预算可开启限流）。"},
    "sqlpool.empty_monitor": {"en": "No SQL running right now.", "zh": "当前没有正在运行的 SQL。"},
    ...
    "app.apply": {"en": "Apply", "zh": "应用"},
    "app.running": {"en": "Loading…", "zh": "加载中…"},
    "app.generate": {"en": "Make interactive", "zh": "生成交互看板"},
    "app.generate_tip": {"en": "Compile this board's questions into an interactive, parameterized dashboard",
                         "zh": "把本看板的问题编译成可交互的参数化看板"},
    ...
    "app.error_hint": {"en": "Adjust your request in the box below and try again.",
                       "zh": "在下方改一下要求再试一次。"},
    "app.edit_dashboard": {"en": "Edit", "zh": "编辑"},
    "app.refresh": {"en": "Refresh", "zh": "刷新"},
    "dash.boards_home": {"en": "Boards", "zh": "看板库"},
    "dash.untitled": {"en": "Dashboard", "zh": "看板"},
