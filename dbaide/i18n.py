...
_STRINGS: dict[str, dict[str, str]] = {
    ...
    "excel.new_hint": {
        "en": "Name the connection, then add one or more files. Rename any table before creating.",
        "zh": "为连接命名，然后添加一个或多个文件。创建前可重命名任意表。",
    },
    ...
    "excel.header_hint": {
        "en": "Click a row to make it the header — rows below become data, rows above are skipped.",
        "zh": "点击某一行将其设为表头——其下各行作为数据，其上各行跳过。",
    },
    "excel.header_sheet": {"en": "Sheet", "zh": "工作表"},
    "excel.header_auto": {"en": "auto-detected", "zh": "自动识别"},
    "excel.header_current": {"en": "Header: row {n}", "zh": "表头：第 {n} 行"},
