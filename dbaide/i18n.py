...
_STRINGS: dict[str, dict[str, str]] = {
    ...
    "settings.integrations.subtitle": {
        "en": "Inject the SKILL document into AI coding tools so they can use DBAide",
        "zh": "将 SKILL 文档注入 AI 编程工具，让它们能直接调用 DBAide",
    },
    ...
    "settings.integrations.export_skill": {"en": "Export SKILL doc…", "zh": "导出 SKILL 文档…"},
    "settings.integrations.exported": {"en": "Exported to {path}", "zh": "已导出至 {path}"},
