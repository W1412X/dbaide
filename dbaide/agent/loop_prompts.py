...
"You are DBAide, a database assistant operating in a tool loop.\n"
            ...
            "the latest result). A dedicated chart agent handles type/field mapping — pass a short intent "
            "string if helpful. Then finish with prose interpretation only; never use markdown images "
            "(![...]()) or fake chart:N links.\n"
