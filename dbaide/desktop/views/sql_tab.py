...
class SqlTab(QWidget):
    ...
    def __init__(self, parent=None) -> None:
        ...
        toolbar = QHBoxLayout()
        self.run_btn = compact_button(t("sql.run"), primary=True, width=72)
        ...
        self.more.add_action(t("sql.validate"), lambda: self.validate_requested.emit(self.editor.toPlainText()))
        self.more.add_action(t("sql.explain"), lambda: self.explain_requested.emit(self.editor.toPlainText()))
