    ...
    def run(
        ...
        *,
        ...
        if response.sql:
            ...
            result.query_plan = self._build_query_plan(request.question, response.sql, limit=request.limit)
            ...
            result.validation_report = self._validate_sql(response.sql, database=database, limit=request.limit)
